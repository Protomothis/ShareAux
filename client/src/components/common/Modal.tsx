    ...
    <>
      ...
      <DialogPrimitive.Popup
        className={cn(
          ...
          fullscreenMobile
            ? 'inset-0 translate-0 max-w-full rounded-none lg:inset-auto lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:max-h-[90vh] lg:max-w-2xl lg:rounded-xl'
